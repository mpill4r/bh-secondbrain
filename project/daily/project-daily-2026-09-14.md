...
Run today's Business Quantification workshop with Tereza Foltýnová — prep is done (`product/solution-space/ai-initiatives-okr-framework.md` + the sticky-note board at https://claude.ai/code/artifact/595fd81a-5193-43cf-adb9-33f0eb42bded). Copy-paste from the board live, confirm the 2 prefilled cards (Reklamace, Fakturace od dodavatelů), fill the 9 blank ones using the cheat-sheet's per-field questions.
