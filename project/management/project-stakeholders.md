...
| Sentiment context | Detail-oriented and collaborative; pushes for concrete two-sided timelines to avoid dev misalignment, but flexible on exact dates ("just sometime next week is fine"). Praised the reklamace app demo unprompted, called it clean and simple. His interest in per-user test logins is about Axapta-log traceability, not security. **Update (2026-09-23)**: on the Fakturace doprav API-contract renegotiation specifically, showed a notably less collaborative pattern — rejected Filip's proposal outright with no counter-proposal, then replied to a simplified follow-up with "no time, will look next week"; has previously argued some asks "should have been done by AI." A contrast worth tracking against his earlier collaborative history rather than assumed to be his general disposition. |
| Communication preference | -tbd- |
...
| Status | Active |
| Notes | Name spelling confirmed 2026-09-10 (was low-confidence "Egermajerová" from 2026-09-07) — attended directly, correctly transcribed as "EGRMAIEROVÁ Jana". Actively working with Tereza Foltýnová on consolidating the reklamace supplier Excel (3-4 source tables, not yet fully reconciled); has dedicated time allocated to this work. Floated by Tereza on 2026-09-15 as a possible Reklamace domain-expert alongside/instead of Petr Spilka (STK-014) — unconfirmed, Tereza to check with Spilka directly. Source: 2026-09-07-ai-portfolio-roadmap-scope-review, 2026-09-10-viapharma-reklamace-uat-fakturace-doprav-demo, 2026-09-15-business-quantification-reklamace-fakturace-doprav On 2026-09-25, Filip Černý credited her with a huge consolidation effort: she turned the ~300-sheet per-supplier Excel into a single ~300-row table. She is responsive (the only person who replied on the rozvozový list contract gap) and suggested ~2 editors per warehouse for supplier data. Jindřich will get the editor/viewer counts from her. Filip is ~90% sure she has edit access in Axapta. Source: 2026-09-25-reklamace-supplier-data-source-options. |
