...
| Status | Active |
| Notes | Handles access approvals blocking the order-prediction (AKS) and voicebot streams. As of 2026-09-02: optimistic ETA for AKS access is today or tomorrow morning (2026-09-03); firewall/permission requests now take ~1 hour once submitted (down from ~2 weeks), owned by the Network Team. Also chasing the Atlantis-side contact ("Tecl") for the voicebot's public IP/domain needs. Also BigHub's primary day-to-day infra contact for MaxBuddy specifically (per Jura Brázdil, 2026-09-03) — distinct from Martin Hrášek (STK-038), the higher-tier BDC escalation contact. As of 2026-09-23, several requests remain queued behind him weeks-long (Reklamace email-draft group setup; Jura's platform database access), prompting Jindřich to escalate the broader AKS/BDC turnaround pattern at management level rather than chase Vláďa personally further. Source: 2026-09-01-dr-max-x-bighub-project-status-sync, 2026-09-02-aks-atlantis-infra-sync, 2026-09-03-maxbuddy-chatbot-ocr-project-handoff, 2026-09-23-cross-project-status-sync-reklamace-fallout-listing-blockers, 2026-09-23-ai-platform-prototype-walkthrough-navigation-modular-reporting |
