...
| Joined | 2026-09-01 |
| Left | — |
| Notes | Owner and sole user of this second brain. Works as a PM at BigHub. Formal role on the Dr. Max account: AI Analyst, working alongside Jindřich Tůma. Formally introduced to the ViaPharma logistics team on 2026-09-03 (previously introduced only to core Dr. Max/vendor contacts, 2026-09-01). On 2026-09-03, received a project handoff from Jura Brázdil (specs, technical docs, session logs) for MaxBuddy/chatbot/OCR — building a personal sub-repo/harness to process this material with Claude, echoing the "umbrella + per-project harnesses" architecture idea from 2026-09-02. Got partial VPN access working (MaxBuddy admin interface reachable; other resources still blocked) — fully resolved 2026-09-04. On 2026-09-04, scope explicitly confirmed as Dr. Max exclusively (at least the first month) — not the broader cross-client AI platform; owns the "Product Scope" X-Manager ticket from Kateřina Kadlecová. On 2026-09-10, offered to run a short usability-testing session with the Dr. Max CC team to observe app usage directly and feed findings into the roadmap with Jura Brázdil — pending scheduling; also asked Mertová whether X-Manager could be reused by other Dr. Max streams (deferred by Jindřich pending Dudaško's DevOps environment project). On 2026-09-16, in an internal DevOps/Kanban status sync, gave a same-day Listing update: sent the spec to Jan Sovka for review (comments received, mostly minor per Marek's own read despite Sovka calling it significantly broken), and held an informal call with Petr Neuman agreeing to reconvene next week to properly kick off the project with domain expert Michaela Vdovicynová. Reiterated that the spec's real value is diagnosing why Listing has stalled since the start, not just documentation. Requested a short KPI-alignment check-in, deferred to a future session. On 2026-09-17, in the recurring Lexie/Max/Maxie weekly sync, reframed the Lexie design-feedback ask for Dr. Max directly ("we need your problem, not your solution") and took ownership of coordinating a follow-up design working session once Dr. Max's pain-point list arrives; also took the action to coordinate directly with "Míša"/Michal Machata (Prague) on X-Manager reuse for other Dr. Max streams. On 2026-09-21, heard Tomáš Dudaško's AI Platform vision directly for the first time and agreed a 3-phase delivery sequencing with him (see [[ASM-115]]); took ownership of drafting a written design brief for Jura Brázdil (rather than prescribing a design himself) to drive Phase 1, incorporating directional steer per Jindřich's request. On 2026-09-24, shared X-Manager during the weekly sync. Answered Mertová's barge-in question (ElevenLabs certainly stops and listens; handling of the interruption's context unconfirmed; will investigate with Jura) and ElevenLabs voice options. Told Kadlecová that Lexie's redesign folds into the platform redesign and padding tweaks are low priority ([[ASM-156]]). Asked Mertová for an email confirmation ahead of the meeting straight after; she will try by 2026-09-25. On 2026-09-24, presented the BQ tracker status to Dudaško (arriving late from the CC sync); Dudaško credited the result. Owns adding a KPI measurement column and collecting measurement methods from every business owner, starting with Tereza Foltýnová on 2026-09-25, and the department AI-initiative backlogs (target end of November). Raised phase-level success milestones (Dudaško: case by case). Framed the prototype demo as UX-first. Source: 2026-09-01-dr-max-x-bighub-project-status-sync, 2026-09-03-viapharma-logistics-status-reklamace-demo, 2026-09-03-maxbuddy-chatbot-ocr-project-handoff, 2026-09-04-ai-platform-standup-xmanager-lexi-demo, 2026-09-10-lexie-max-maxie-weekly-sync, 2026-09-16-devops-kanban-rollout-status-sync, 2026-09-17-lexie-max-maxie-weekly-sync, 2026-09-21-ai-platform-vision-discovery-dudasko, 2026-09-24-lexie-max-maxie-weekly-sync, 2026-09-24-ai-initiatives-bq-review-platform-prototype-demo-dudasko On 2026-09-25, took over the Reklamace documentation and became BigHub's single point of contact for all logistics AI initiatives ([[ASM-177]]); ViaPharma/Dr. Max should email his external account. Source: 2026-09-25-tereza-foltynova-reklamace-focus-logistics-initiatives-table. |
...
| Joined | -tbd- |
| Left | — |
| Notes | Previously carried most of the client-side PM burden on Dr. Max. Transitioning out of day-to-day ownership as Marek and Jindřich take over; handed off context to Marek (call completed). On 2026-09-16, stood in for Jindřich Tůma (out that day) to run a TEO/OCR technical sync with Dr. Max — arranged local recording via Tomáš Burda's account since she couldn't record from her own, and handled scheduling for the next sync. On 2026-09-21, in an internal OCR/platform working session, pushed for a correction-feedback loop back from Radim Švarc's team via API (see [[ASM-120]]), raised ServiceNow export scope as an undefined next step (resolved to Radim's team owning it, see [[ASM-121]]), committed to chasing Vladislav Tvarůžek/BDC on Jura's unresolved AKS node-pool blocker before the next day's meeting, and flagged budget/scope discipline on Jura's unprompted Max Chatbot UX additions. On 2026-09-22, attended and took notes on the recurring TEO/OCR technical sync — recorded two apparent conflicts against very recent decisions (Blob storage/BDC dependency vs. [[ASM-088]], see [[ASM-129]]; multi-candidate disambiguation rejection vs. [[ASM-119]], see [[ASM-128]]), both flagged for reconciliation with Jura rather than resolved on the spot. On 2026-09-25, in a 1:1 with Marek, remained an active adviser despite the handover: reframed the TEO/OCR Excel question around the twice-yearly service cycle (Excel stays for autumn 2026, non-Excel solution before spring 2027, [[ASM-165]]), explained the ~3 FTE shared capacity pool ([[ASM-167]]), and flagged the missing TEO process discovery ([[ASM-168]]). Several team members had called her the day before about team frictions; she has become the team's informal confidant, which she finds rewarding. Source: 2026-08-25-marek-onboarding-with-jan-sovka, 2026-09-16-teo-ocr-technical-sync-pilot-results, 2026-09-21-ocr-progress-ai-platform-prototype-sync, 2026-09-22-teo-ocr-technical-sync-spedos-disambiguation-reversal, 2026-09-25-alana-1on1-teo-phasing-capacity-pool-team-dynamics |
...
| Joined | -tbd- |
| Left | — |
| Notes | Primary day-to-day sales contact with Tomáš Dudaško on the client side. Formally introduced Marek to Dr. Max client contacts on 2026-09-01. Originally delivered the "no shared roadmap" message to Dudaško once BigHub's internal shared-platform vision was dropped (~2026-05), which shaped how Dudaško now frames his AI-platform investment ask. Jan Sovka flagged (2026-09-08) that Jindřich/Marek should sync with him before further platform conversations with Dudaško, to avoid conflicting messaging. On 2026-09-22, asked Marek directly for a full backlog/pipeline list (effort + expected Azure spend) for Microsoft partnership costing purposes; Marek shared the existing rough backlog but flagged it isn't cost-planned. Jindřich considers the request premature and will coordinate with him directly once Dudaško's Friday priority sign-off lands (see [[ASM-126]]). Source: 2026-08-25-marek-onboarding-with-jan-sovka, 2026-09-01-dr-max-business-sync, 2026-09-01-dr-max-x-bighub-project-status-sync, 2026-09-08-ai-platform-strategy-history-with-jan-sovka, 2026-09-22-ai-portfolio-business-value-review-reklamace-reframe (relayed) |
...
| Joined | -tbd- |
| Left | — |
| Notes | Surname confirmed as Turner (2026-09-02) — resolves the "Kuba Turner" mentioned in the 2026-09-01 listing-intro note, originally misattributed to reklamace; confirmed working on MaxBuddy instead (see ASM-007, Decided 2026-09-02). Update 2026-09-03: PM confirmed Turner is also actively engaged in reklamace-app backend work (OAuth/Entra ID auth design, hardcoded test-login issuance, Axapta write integration) alongside Jura Brázdil's (STK-026) ownership — both are true; see ASM-007 amendment. On 2026-09-10, active in both halves of the ViaPharma sync — pushed back on Petr Sláma's (STK-034) testing-timeline concerns with a clear feature-by-feature testing model, and in the Fakturace doprav demo consistently raised the open-kiosk security/LLM-injection risk (see ASM-052) that document-type validation alone doesn't solve. On 2026-09-16, working on Reklamace OAuth — received OAuth server details from an unnamed external Boomy-side contact, needs to implement and test; agreed with Petr Sláma not to let this block warehouse testing, deploying only once tested on-site. Flagged a still-open question on CERT/email-registration status needed for the Reklamace mailbox app, to raise with infra. As of 2026-09-25, an unresolved friction thread: he opened a group chat with Marek and Jindřich (no call), framing the issue as having had too much on his plate. Marek's last reply, that seniority isn't only about skills, has gone unanswered. Marek sees him as a strong, reliable senior but is parking the issue. Alana notes he says things directly and many people don't like him for it. Source: 2026-08-25-marek-onboarding-with-jan-sovka; identity confirmed 2026-09-02; role expanded 2026-09-03-viapharma-logistics-status-reklamace-demo, 2026-09-10-viapharma-reklamace-uat-fakturace-doprav-demo, 2026-09-16-devops-kanban-rollout-status-sync, 2026-09-25-alana-1on1-teo-phasing-capacity-pool-team-dynamics As of 2026-09-25 (per Filip Černý): the main part of the Reklamace email-draft feature is done; it is blocked on infra delivering Microsoft Graph API access. Source: 2026-09-25-reklamace-supplier-data-source-options. On 2026-09-24, pushed back firmly on Sláma: AI is used where it makes sense but can't invent procedures that exist nowhere in writing; cited the approved Phase 1.1 "manual negotiation" line; called per-role supplier contacts a new, separately scoped change; deferred the knowledge-base location call to Jindřich/Marek. Source: 2026-09-24-viapharma-reklamace-knowledge-base-standoff. |
...
| Joined | -tbd- |
| Left | — |
| Notes | Confirmed by Marek (2026-09-02) as owning both reklamace and freight invoicing. Resolves a conflict with the 2026-09-01 listing-intro note, which had named "Kuba Turner" as building reklamace — Turner is instead associated with MaxBuddy. See ASM-007 (Decided). On 2026-09-03, demoed the Max chatbot live to strong client praise (order status, pharmacy locator, e-recepty, medication lookup, all LLM-backed with a medical-advice guardrail); also owns MaxBuddy (oldest project — pharmacist upsell tool, originally a dosage-checking product until a medical-device certification requirement froze that feature) and a new early-stage OCR project (pharmacy equipment service-protocol extraction, targeting Dr. Max's November inspection cycle). Taking over the shared AI platform infrastructure from Viliam Gago (STK-027) once the new AKS sandbox is ready, migrating MaxBuddy and Lexie onto it. On 2026-09-04, flagged an urgent AKS node-pool cost issue (idle pools costing money, needs BDC cleanup or a cross-project node-selector redeploy); proposed the AI platform's frontend stay a standardized template by default, customized per client only on explicit request. On 2026-09-08, gave the technical reality check on the platform's current state: in practice it's just one RAG/document-retrieval product, MaxBuddy still isn't in it (blocked on the new AKS since early August), and today's shared setup has a shared DB with no isolation between use cases plus a single shared admin account. Confirmed the existing role-based permission system is Lexie-specific, not platform-wide. Plans to self-migrate MaxBuddy and Max Chatbot into the platform once the new AKS lands and unify its UX around a single "crossroads" landing page; also wants a standard changelog convention for platform pull requests. Confirmed he has some spare capacity for this work and expects it to help rather than purely cost him, since he's migrating his own projects into it anyway. On 2026-09-10, demoed a live (VPN-gated) Max chatbot test environment with mocked sample test scenarios (not yet wired to production data); confirmed he maintains a near-complete internal platform documentation doc (screenshots + descriptions) and will finish and send it out; agreed to open a Lexie design-compromise ticket with Jindřich, explaining the platform-wide design-consolidation plan (centralize all Dr. Max apps under one entry point first, unify per-app design afterward); committed to researching whether a shared, multi-group test account with an in-app role switcher can support concurrent multi-tester use without conflicts. On 2026-09-16, ran a blind validation of the TEO/OCR pipeline against a real, untouched 2025 dataset (140 protocols, 2 pilot vendors) — results a few points above prior benchmarks, though he cautioned some of that may be luck; caught and is investigating 2 new bugs Michaela Albrechtová (STK-042) flagged (duplicated defects-text field, one unflagged genuine error) plus a known missing-address extraction failure and bounding-box crop imprecision. Migrating the platform project to new AKS node pools and self-provisioning Blob storage for a TEST environment — explicitly confirmed this needs no BDC/infra-team involvement to create (see [[ASM-088]]). Open to expanding the autumn pilot to a 3rd vendor if Dr. Max sends samples, given his pipeline is now reusable (~1 day of work per new vendor, see [[ASM-089]]). On 2026-09-17, in the Lexie/Max/Maxie weekly sync, proactively built an in-app "pseudo-ticket" view surfacing every feedback-form submission (addressing a duplicate-testing complaint raised 2026-09-10); walked through fixes for 7 pharmacy-location-search bugs, a Paralen stock-lookup false negative, a false call-transfer claim, and a city/district-recognition issue (upgraded the underlying model GPT-5.1→GPT-5.4, switched to fuzzy/syllable-based matching); confirmed nothing is stored server-side today (conversations live only in-browser). Laid out a 3-phase go-live plan (prod backend connection → BDC security clearance, hidden → public toggle) targeting end of September for BigHub's side, while accepting Mertová's end-of-October public date. Asked Dr. Max to write a first-person "tone brief" for the chatbot's prompt. Dropped off the call before the end (missed the final Lexie bug reports). On 2026-09-21, shipped concrete TEO/OCR pipeline improvements (classify-against-known-branch-list disambiguation, ranked candidate alternatives for ambiguous dates/addresses) that back-tested to a ~54% improvement in clean/no-review rows on the spring batch; fixed a previously-flagged silent number-misread error via tighter bounding-box cropping; still blocked on an AKS node-pool connectivity issue reported to Vladislav Tvarůžek since Friday with no confirmed resolution. Independently, and before being formally asked, built a working AI Platform prototype (role-based login landing, multi-role hub/switcher, super-admin technical view) matching almost exactly what Dudaško described the same morning — validated Phase 1 as a straightforward consolidation of existing interfaces into one shell, not a redesign; hosted PIN-protected on his own Cloudflare account as a clickable, non-functional deliverable for Wednesday 2026-09-23. Also shipped unprompted Max Chatbot UX polish (URL-aware contextual prompts, a star-rating feedback widget, an editable per-session tone prompt) — Alana flagged budget/scope discipline given none of it was formally requested; Jura maintains it was incidental to existing feedback-triage work. On 2026-09-22, in the recurring TEO/OCR technical sync, committed to giving SPEDOS (the real vendor behind the earlier "PEDOS" name uncertainty, see [[ASM-127]]) additional pipeline attention and sending an export by end of week; will run the first offline batch (incl. JSON) against real Thermetal autumn-2026 protocols Míša sent. Two of his very recent decisions were flagged as apparently contradicted by this session's notes, pending his direct reconciliation: Blob storage/deployment described as still depending on Dr. Max infra/BDC (see [[ASM-129]], vs. his own ASM-088 resolution), and TEO rejecting multi-candidate disambiguation output (see [[ASM-128]], vs. his own ASM-119 decision) — also owes Radim an answer on what batch-creation logic BigHub uses for his twice-weekly Blob storage pushes. On 2026-09-23, walked Marek through the AI Platform prototype's super-admin navigation, modular per-project reporting (manifest-driven), and role-based views inherited entirely from Dr. Max's AD groups; deliberately deferring all visual/design work until navigation is validated with Dudaško (see [[ASM-147]]). Proposed a cross-platform RAG "ask anything" agent, kept in reserve (see [[ASM-146]]); flagged a real security gap — MCP server registration leaks secret/header values to any agent reading server descriptions (see [[ASM-145]]); identified that "platform" and "Lexie" had been conflated as one concept, now being explicitly separated (see [[ASM-144]]). Remains fully blocked on further real deployment until database access comes through from Vláďa/BDC (still pending); also needs to harden platform security and migrate MaxBuddy/Chatbot Max under the platform once unblocked. Confirmed on track for Chatbot Max bug fixes ahead of the next status meeting; targeting Friday to demo the refreshed prototype to Dudaško alongside Marek. On 2026-09-24, demoed a large batch of Max chatbot fixes and new features (stable/candidate switch, context header, end-conversation flow, golden-conversation regression replays, URL-contextual bubbles, rebuilt opening-hours search). Candid that Max runs on GPT-5 mini and has hit its instruction ceiling ([[ASM-149]]); asked for keyword-only tone input ([[ASM-150]]); committed to a model cost projection and model switcher for the next meeting. Lapsed on X-Manager updates (apologized, fixing after the call). Has production order-DB access but hadn't yet requested test-DB access, and is unsure who at Dr. Max infra to ask. On 2026-09-24, demoed the AI Platform Phase 1 prototype to Dudaško from the Krkonoše over a mobile hotspot; well received. Gave the first-release estimate (~3 weeks after DB access) and explained the DB repro script handed to Tvarůžek (old cluster works, new doesn't). Retesting DB access after the meeting. Source: 2026-09-02-order-prediction-dashboard-walkthrough, 2026-09-03-max-chatbot-demo-lexi-maxi-status-sync, 2026-09-03-maxbuddy-chatbot-ocr-project-handoff, 2026-09-04-ai-platform-standup-xmanager-lexi-demo, 2026-09-08-ai-platform-technical-deepdive-jura-brazdil, 2026-09-10-lexie-max-maxie-weekly-sync, 2026-09-16-teo-ocr-technical-sync-pilot-results, 2026-09-17-lexie-max-maxie-weekly-sync, 2026-09-21-ocr-progress-ai-platform-prototype-sync, 2026-09-22-teo-ocr-technical-sync-spedos-disambiguation-reversal, 2026-09-23-ai-platform-prototype-walkthrough-navigation-modular-reporting, 2026-09-24-lexie-max-maxie-weekly-sync, 2026-09-24-ai-initiatives-bq-review-platform-prototype-demo-dudasko |
...
| ID | STK-057 |
| Name | Kuba Vodička |
| Aliases | Jakub Vodička (presumed full name, unconfirmed) |
| Role | -tbd- (BigHub; earlier lead whose working style the long-standing Dr. Max devs are used to) |
| Location | -tbd- |
| Status | -tbd- |
| Joined | -tbd- |
| Left | -tbd- |
| Notes | Low-confidence entry, from a single mention. Alana Sihelská named him alongside herself as someone the longer-standing BigHub devs had worked with and whose style they're used to, in contrast to Jindřich Tůma's. Current role and involvement unknown. Source: 2026-09-25-alana-1on1-teo-phasing-capacity-pool-team-dynamics |
...
| Influence | High |
| Sentiment | Neutral |
| Sentiment context | Currently "a bit frosty" — has been paying for months without seeing enough visible delivered value; expects results now that several streams are nearing production. Reinforced 2026-09-21: right vision, but visibly worn down by past unmet promises from predecessors (Jindřich's read); wants visible, concrete progress on a short cadence. On 2026-09-22 (relayed by Jindřich), pushing back somewhat on Reklamace being reframed as digitization rather than AI — wants to align with the head of logistics before deciding whether to continue it as digitization-only or close it (see [[ASM-122]]). |
| Communication preference | -tbd- |
| Expectations | Business cases and ROI justification for proposed work; visible delivery |
| Last interaction | 2026-09-24 (2026-09-24-ai-initiatives-bq-review-platform-prototype-demo-dudasko) |
| Status | Active |
| Notes | Named Owner/Customer for MaxBuddy and Lexie on the BigHub roadmap sheet (2026-09-02). Confirmed 2026-09-02 as the IT/budget-side owner of Lexie, co-owning alongside Mertová (STK-017), who holds the operational/product side — not a conflict, see ASM-006 (partially resolved). On 2026-09-08, asked (via Jindřich) for visible investment in the AI platform — unified test/prod environments, improved UX/visual polish, and consolidation of all Dr. Max BigHub projects onto it. Sat down with an AI assistant to draft a large requirements Excel, which both Jan Sovka and Marek independently assessed as ~70% governance/compliance-framed and not addressing actual use cases. Near-term interest is dependency visibility, cost visibility, and usage metrics rather than governance minutiae. On 2026-09-21, gave his AI Platform vision directly for the first time (previously only relayed secondhand): platform-as-a-service (every AI tool, chat or programmatic, routes through it for FinOps visibility — see [[ASM-112]]), a unified role-based tool directory including tools with their own frontend (see [[ASM-113]]), and a single unified Lexie replacing per-department instances (see [[ASM-114]]); agreed a 3-phase sequencing (see [[ASM-115]]) and deferred his longer-term agentic-workflow-builder want to a future conversation (see [[ASM-116]]). Also aligned with Jindřich that BigHub's adoption-campaign role stops at awareness/comms, with training/rollout staying entirely with Dr. Max's own training center and expert groups (see [[ASM-117]]), and repeated a months-long complaint about the lack of reliable MaxBuddy reporting (see [[ASM-118]]). Firmly corrected Marek's Claude analogy ("určitě nechci, abyste přepisovali Claude") but engaged constructively throughout and agreed cleanly to the proposed phasing. Per Jindřich's read immediately after the call: has "the right vision" but is visibly worn down by past unmet promises from predecessors on this account — reinforces the existing "frosty" sentiment read below; wants visible, concrete progress on a short cadence (flagged Wednesday 2026-09-23 as a target for first UX variants) rather than a polished-but-delayed result. On 2026-09-22 (relayed by Jindřich, not yet a direct interaction): pushing back on Reklamace's AI framing after being told it's really digitization (see [[ASM-122]]); a combined session covering the reklamace decision plus a full portfolio priority review is being scheduled for Thu 2026-09-24 or Fri 2026-09-25. On 2026-09-23 (relayed by Jindřich), revealed he plans to retire Axapta within ~6 months and will accept higher near-term dev cost on Reklamace for a portable solution (see [[ASM-139]]). Per Jura's read (2026-09-23, not yet a direct interaction on this point): wants adoption/usage reporting on the AI platform itself, and combined test+prod cost visibility (see [[ASM-148]]); some of his frustration with "the platform" is attributed to the team having previously conflated it with Lexie specifically (see [[ASM-144]]) — being corrected going forward. Prototype demo targeting Friday 2026-09-25. On 2026-09-24, in the combined BQ review and AI Platform prototype demo, gave the most positive feedback on record. The BQ tracker delivers what he "always wanted and never got" from the business, and of the prototype: "after a very long time I can tell BigHub: good job, you've got the costs nicely worked out and a nice frontend". Demanding and forward-leaning: immediately asked for KPI measurement methods ([[ASM-159]]), "PR" value stories for the 2026-09-29 management meeting ([[ASM-160]]), department backlogs by end of November ([[ASM-161]]), and Zabbix integration ([[ASM-162]]). Wants cost reporting as a total with a breakdown. Said Tvarůžek told him DB access is done (disputed, [[ASM-164]]). Connected BigHub with Marek Dvořák (marketing). Has a theoretical-CS PhD (programming-language semantics). Per Alana Sihelská (2026-09-25): his mood swings, and the positive reaction of 2026-09-24 may not last ("in a week it'll be different"). Same day, the positivity ended at the short Listing meeting that followed. Also learned: holds a doctorate in theoretical computer science and warmly engaged with a friend of Jura's about an old programming language. Assumed (unconfirmed) to be the "Tomáš" who confirms the accumulated budget in the ~3 FTE pool ([[ASM-167]]). Source: 2026-08-25-marek-onboarding-with-jan-sovka, roadmap sheet 2026-09-02; resolved 2026-09-02, 2026-09-08-ai-platform-strategy-history-with-jan-sovka, 2026-09-21-ai-platform-vision-discovery-dudasko, 2026-09-22-ai-portfolio-business-value-review-reklamace-reframe (relayed), 2026-09-23-cross-project-status-sync-reklamace-fallout-listing-blockers (relayed), 2026-09-23-ai-platform-prototype-walkthrough-navigation-modular-reporting (relayed), 2026-09-24-ai-initiatives-bq-review-platform-prototype-demo-dudasko, 2026-09-25-alana-1on1-teo-phasing-capacity-pool-team-dynamics |
...
| ID | STK-011 |
| Name | Luboš Vosmek |
| Aliases | "Luca" (per Tomáš Dudaško, 2026-09-21 — see Notes) |
| Organization | Dr. Max |
...
| Status | Active |
| Notes | Business owner of MaxBuddy **without budget** — IT/budget authority sits with Tomáš Dudaško (STK-010). Domain-expert responsibilities on his side split between Lukáš Sýč (functionality/decisions/escalation — bridges BigHub, Farmy, BDC, and Vosmek) and Jiří Trajer (STK-049, data-feed only via Power BI, not involved in feature decisions) — see [[ASM-097]], [[ASM-098]], [[ASM-099]]. Gave a JTBD origin story explaining MaxBuddy's dosage-checking-to-upsell pivot was driven partly by a need to build pharmacy-staff trust before introducing "AI," and stated the current live upsell feature is data/rule-based rather than LLM-driven. Source: 2026-08-25-marek-onboarding-with-jan-sovka, 2026-09-03-maxbuddy-chatbot-ocr-project-handoff, 2026-09-17-business-quantification-maxbuddy-vosmek. **Identity resolution (2026-09-22, PM confirmation)**: this is the "Luca" Dudaško named on 2026-09-21 as MaxBuddy's "osmec" (expert-group lead) — the operational owner with escalation authority and direct access to the training center for post-rollout adoption feedback, distinct from BigHub or the training center itself. Consistent with his already-tracked "expert group" leadership above. Not related to the separate Lukáš Sýč/Szücs identity question on STK-031. See [[ASM-117]], "Osmec" in project-knowledge. Per Jindřich Tůma (2026-09-22, source uncertain — possibly relayed via a third party), reportedly ready to plan and fill MaxBuddy's backlog; Marek to schedule a planning meeting with him this week. |
...
| Status | Active |
| Notes | Distinct from STK-008 "Lukáš" (BigHub developer) — same first name, different person/org. On 2026-09-03, confirmed the Jump Server access request (BigHub direct access to Dr. Max logs/Mongo) still has "definitely not moved" after ~1 month silence; agreed to add Lukáš Starenko (STK-028) to the "CZE AXE BOOM AI" Teams group per Filip Černý's request. On 2026-09-04, assigned to figure out a workable test-user/auth approach for the Lexie platform (local service account vs. AD group role management) — low priority, unresolved as of that date. **BQ tracker (2026-09-25)**: listed as MaxBuddy domain expert, the IT liaison for Luboš Vosmek who handles functionality/decisions and is the main contact for outages or changes (the bridge between BigHub, Farmis, BDC and Vosmek). ⚠️ Possible duplicate of STK-031 (same name); not merged. Source: 2026-09-01-dr-max-x-bighub-project-status-sync, 2026-09-03-viapharma-logistics-status-reklamace-demo, 2026-09-03-maxbuddy-chatbot-ocr-project-handoff, 2026-09-04-ai-platform-standup-xmanager-lexi-demo, BQ tracker (new_Přehled), 2026-09-25 |
...
| Influence | -tbd- |
| Sentiment | Neutral |
| Sentiment context | Constructive and supportive after the 2026-09-23 narrative. Open about frustration with the agile/no-spec history on Reklamace, but explicitly invites questions and proposed an in-person meeting herself. |
| Communication preference | -tbd- |
| Expectations | -tbd- |
| Last interaction | 2026-09-25 (2026-09-25-tereza-foltynova-reklamace-focus-logistics-initiatives-table) |
| Status | Active |
| Notes | Name corrected 2026-09-11 from "Tereza Foltová" to "Tereza Foltýnová" per PM (surfaced via a Jindřich Tůma message referencing an upcoming Monday meeting with her on AI initiatives). Supplier Excel for the reklamace rollout still expected Monday, per her earlier commitment (reconfirmed 2026-09-02). On 2026-09-03: consolidating ~120 suppliers into a single structure, working three-deep on it (including Jana, despite being on vacation); original 2026-09-07 deadline at risk given the manual-verification load — committed to a status update Monday 2026-09-08 (~80% clean estimate). Also coordinating with Dr. Max accounting to add an Axapta reference number and customer-vs-vendor distinction to the same data; staying in Excel for now rather than moving to a database. Confirmed 2026-09-09 as the primary requester behind the 2026-09-10 Logistika roadmap walkthrough — reklamace scope is expected to largely match what she asked for. On 2026-09-10, still consolidating the supplier Excel with Jana Egrmaierová (STK-044, ViaPharma) — data across 3-4 source tables doesn't fully reconcile yet; targeting a demo to Filip Černý (STK-006) next Tuesday, wants a short session with him specifically rather than a broader walkthrough. On 2026-09-15, ran the first live Business Quantification interview with Marek Pillár, covering Reklamace and Fakturace doprav — gave detailed, well-grounded JTBD answers and pushed back on her own initiative's inflated savings estimate rather than accepting it (see [[ASM-072]]); requested naming clarity on the roadmap (domain qualifiers matching the Core/Ecom convention), which incidentally helped resolve part of [[ASM-006]]; only covered 2 of ~11 prepped initiatives before running out of time, unavailable from Friday. On 2026-09-23, was the source of a "BigHub doesn't want to deliver" narrative on Reklamace circulating client-side — calibrated directly by Jindřich, who explained the digitization framing; she understood it but showed some confusion afterward (asking whether the project would move to "their IT" or Dr. Max's own infra) and wants to communicate with Rudolf Žůrek (STK-024) directly before the planned management decision meeting. On 2026-09-24, named as Marek's logistics counterpart for a 2026-09-25 session: agree the Part A (finish Reklamace/Fakturace specs) / Part B (new logistics AI initiatives) split and collect KPI measurement methods. Source: 2026-09-01-dr-max-x-bighub-project-status-sync, 2026-09-02-logistics-listing-team-sync, 2026-09-03-viapharma-logistics-status-reklamace-demo, 2026-09-09-logistics-cc-roadmap-presentation-prep, 2026-09-10-viapharma-reklamace-uat-fakturace-doprav-demo, 2026-09-15-business-quantification-reklamace-fakturace-doprav, 2026-09-23-cross-project-status-sync-reklamace-fallout-listing-blockers (relayed via Jindřich), 2026-09-24-ai-initiatives-bq-review-platform-prototype-demo-dudasko On 2026-09-24, arranged the shared testing phone with Petr Spilka ([[ASM-182]]). On 2026-09-25, 1:1 with Marek: agreed the Part A/B split ([[ASM-177]]); openly frustrated that Reklamace went agile without a full spec ("it has bitten us") and with the 09-24 "exactly as in the spec" framing, but moved on and invited all questions. She drafts the logistics initiatives table herself ([[ASM-178]]); her reach to Spilka and Žůrek is limited. Proposed an in-person catch-up at Florentinum (2026-09-30 10:00). Source: 2026-09-24-viapharma-reklamace-knowledge-base-standoff, 2026-09-25-tereza-foltynova-reklamace-focus-logistics-initiatives-table. |
...
| Status | Active |
| Notes | Reviewing the reworked freight-invoicing scope, expected mid-September. Confirmed 2026-09-15 (via Tereza Foltýnová, ViaPharma) as Reklamace's owner and tentative domain expert, pending his own confirmation — Jana Egrmaierová (STK-044) floated as a possible alternative domain expert. Role description narrowed from "owns Reklamace and Fakturace doprav" to "owns Reklamace, reviews Fakturace doprav" given today's call reinforced Jan Žižka as the actual Fakturace doprav owner. On 2026-09-23, attended Jindřich's calibration meeting on the Reklamace digitization reframe and understood the explanation. Source: 2026-09-01-dr-max-x-bighub-project-status-sync, 2026-09-15-business-quantification-reklamace-fakturace-doprav, 2026-09-23-cross-project-status-sync-reklamace-fallout-listing-blockers (relayed via Jindřich) Per Tereza Foltýnová (2026-09-25): "owner of Reklamace, the main person for warehouses after Mr. Žůrek". Validates the logistics initiatives table before Žůrek ([[ASM-178]]). Hard to reach: no availability the week of 2026-09-28. Agreed the shared testing phone with Tereza (2026-09-24). Source: 2026-09-24-viapharma-reklamace-knowledge-base-standoff, 2026-09-25-tereza-foltynova-reklamace-focus-logistics-initiatives-table. |
...
| Last interaction | 2026-09-24 (2026-09-24-ai-initiatives-bq-review-platform-prototype-demo-dudasko) |
| Status | Active |
| Notes | Handles access approvals blocking the order-prediction (AKS) and voicebot streams. As of 2026-09-02: optimistic ETA for AKS access is today or tomorrow morning (2026-09-03); firewall/permission requests now take ~1 hour once submitted (down from ~2 weeks), owned by the Network Team. Also chasing the Atlantis-side contact ("Tecl") for the voicebot's public IP/domain needs. Also BigHub's primary day-to-day infra contact for MaxBuddy specifically (per Jura Brázdil, 2026-09-03) — distinct from Martin Hrášek (STK-038), the higher-tier BDC escalation contact. As of 2026-09-23, several requests remain queued behind him weeks-long (Reklamace email-draft group setup; Jura's platform database access), prompting Jindřich to escalate the broader AKS/BDC turnaround pattern at management level rather than chase Vláďa personally further. On 2026-09-24, per Dudaško, told him DB access on the new cluster is done. This conflicts with BigHub's last check (2026-09-23 15:30) and Jura's pending repro-script case forwarded to BDC; see [[ASM-164]]. Source: 2026-09-01-dr-max-x-bighub-project-status-sync, 2026-09-02-aks-atlantis-infra-sync, 2026-09-03-maxbuddy-chatbot-ocr-project-handoff, 2026-09-23-cross-project-status-sync-reklamace-fallout-listing-blockers, 2026-09-23-ai-platform-prototype-walkthrough-navigation-modular-reporting, 2026-09-24-ai-initiatives-bq-review-platform-prototype-demo-dudasko |
...
| Communication preference | -tbd- |
| Expectations | -tbd- |
| Last interaction | 2026-09-24 (2026-09-24-lexie-max-maxie-weekly-sync) |
| Status | Active |
| Notes | Active in the "Dr. Max LLM Platforma" chat alongside William Gago (STK-027) and Lukáš Starenko (STK-028); exact role unknown, not even to Juraj Kmec. Also present in a separate 2026-09-02 AKS/Atlantis infra sync, tagged "EXT" in that meeting's attendee data, raising the Atlantis/ElevenLabs SIP integration topic — role still not fully clear (Dr. Max-side, Atlantis-side, or BigHub-side). Low-confidence entry overall — flagged during routing as thin, kept per PM instruction to route everything. Per Jura Brázdil (2026-09-03): building Maxie (the voicebot), sharing infrastructure with the Max chatbot — same core capability, voice instead of text. On 2026-09-24, Jindřich confirmed Zelený represented BigHub at the Atlantis meeting ~3 weeks earlier (explaining how the voicebot integration would work) and will be invited to the joint Maxie/Atlantis alignment meeting with Mertová and Tecl. Source: 2026-09-02-order-prediction-dashboard-walkthrough, 2026-09-02-aks-atlantis-infra-sync, 2026-09-03-max-chatbot-demo-lexi-maxi-status-sync, 2026-09-24-lexie-max-maxie-weekly-sync |
...
| ID | STK-031 |
| Name | Lukáš Szücs |
| Aliases | Lukáš Síč, Lukáš Sýč, Lukáš Syček (transcription variants — spelling confirmed by PM, 2026-09-21) |
| Organization | -tbd- |
...
| Last interaction | -tbd- |
| Status | Active |
| Notes | Name spelling confirmed by PM (2026-09-21) as "Lukáš Szücs," resolving four prior transcription variants. Lukáš Starenko (STK-028) was pointed to him by Filip Černý to request access. **Possible identity overlap (2026-09-17, still unconfirmed)**: the MaxBuddy Business Quantification call names him (as "Lukáš Sýč") as Luboš Vosmek's (STK-011) IT liaison bridging BigHub/Farmy/BDC — a similar name in a third context (this record's Reklamace Teams/Swagger access, and separately Jindřich Tůma's 2026-09-15 note naming him as BigHub's own order-prediction coordination contact). Flagged for verification, not merged — could be one person spanning roles or several similarly-named people. **Further corroboration (2026-09-21)**: in the AI Platform vision call, Tomáš Dudaško (STK-010) named him as someone who should already know Dr. Max's expert-group ("expertní skupiny") structure end-to-end — consistent with the bridging/escalation role already associated with this entry. Same call separately named "Luca" as the specific MaxBuddy "osmec" (expert-group lead responsible for pharmacy-network rollout) — **resolved 2026-09-22 (PM confirmation)**: "Luca" is Luboš Vosmek (STK-011) himself, not this person — the two identity threads are unrelated. ⚠️ Possible duplicate of STK-012 (same name, Lukáš Szücs); not merged. Per the BQ tracker (2026-09-25), Szücs is MaxBuddy's domain expert and IT liaison. Source: 2026-09-02-logistics-listing-team-sync, 2026-09-17-business-quantification-maxbuddy-vosmek, 2026-09-21-ai-platform-vision-discovery-dudasko, BQ tracker (new_Přehled), 2026-09-25 |
...
| Last interaction | 2026-09-24 (2026-09-24-lexie-max-maxie-weekly-sync) |
| Status | Active |
| Notes | Low-confidence entry — single mention, surname only, not yet contacted. Vladislav Tvarůžek (STK-016) is chasing him to configure the public IP/domain the voicebot integration needs. On 2026-09-24 (spelled "Techl" in the transcript), Mertová named him as the Atlantis person who built Dr. Max's existing IVR "Maxí" with Dr. Max ~2–3 years ago and knows the setup; she asked that he join the joint Maxie/Atlantis alignment meeting Jindřich is organizing. Source: 2026-09-02-aks-atlantis-infra-sync, 2026-09-24-lexie-max-maxie-weekly-sync |
...
| Influence | -tbd- |
| Sentiment | Neutral |
| Sentiment context | Frustrated on 2026-09-24 over the Reklamace reframe (wants his 2026-05-20 written flag on record), but constructive: will implement whatever option is chosen. Earlier: detail-oriented, collaborative, pushed for two-sided timelines. |
| Communication preference | -tbd- |
...
| Last interaction | 2026-09-24 (2026-09-24-viapharma-reklamace-knowledge-base-standoff) |
| Status | Active |
| Notes | New contact, first appearance 2026-09-03. Confirmed 2026-09-07 as the primary "manažer"-type Reklamace contact alongside Jan Kopecký (STK-032). On 2026-09-10, pushed back hard on a proposed short UAT testing window — needs to validate full downstream Axapta financial/logistics effects, not just app UX, citing ~18 process variants and a Finance-team dependency; also personally capacity-constrained in September by two unrelated GoLive projects (a "A-Frame" project and one in Ostrava). Negotiation landed constructively on an October 15-16 UAT start (see ASM-056); he committed to continuous blocker reporting during testing. Also flagged the reklamace-Axapta API documentation lacks enough sequencing detail to start backend dev safely — a dedicated walkthrough was scheduled to resolve it (ASM-057). On 2026-09-23, rejected Filip Černý's Fakturace doprav API-contract revision proposal outright with no counter-proposal, then gave only a "no time, will look next week" reply to a simplified follow-up (see [[ASM-142]]) — a marked contrast with his earlier collaborative engagement on this account. Source: 2026-09-03-viapharma-logistics-status-reklamace-demo, 2026-09-07-ai-portfolio-roadmap-scope-review, 2026-09-10-viapharma-reklamace-uat-fakturace-doprav-demo, 2026-09-23-cross-project-status-sync-reklamace-fallout-listing-blockers (relayed via Filip) On 2026-09-25 (relayed by Jindřich Tůma and Filip Černý), he said Axapta "will be killed," so his team won't do further Axapta-side development for Reklamace ([[ASM-139]]). Filip says he tends to refuse quickly without explaining why and offers no counter-proposals. He hasn't responded to Filip's ~1-week-old flag about rozvozový list fields missing from the API contract ([[ASM-174]]). He is expected to have no objection to exposing the supplier account. Source: 2026-09-25-reklamace-supplier-data-source-options. On 2026-09-24, pushed back hard on the Reklamace digitization reframe: says the original vision was an AI-driven branching email workflow and that he flagged it in writing on 2026-05-20 ("Zentiva" example) ([[ASM-181]]). Visibly frustrated ("we've discussed this five times") and wants a paper trail, not blame. He'll build whatever is decided in Axapta but wants the alternatives on record. His manager, referred to as "Tomáš Blažko", pushes him for visible savings; this may be the same person as "Kim" from earlier meetings (not reconciled). Asked to be included in the Dudaško/Žůrek decision meeting. Requested per-user login on the shared test phone ([[ASM-182]]). Source: 2026-09-24-viapharma-reklamace-knowledge-base-standoff. |
...
| Communication preference | -tbd- |
| Expectations | -tbd- |
| Last interaction | 2026-09-22 |
| Status | Active |
| Notes | Building his own application/API that will call BigHub's OCR pipeline directly — the two systems' integration boundary (who owns which side) still needs defining. On 2026-09-15, in the Business Quantification interview, clarified he is the domain expert/daily contact rather than the business owner — major directional decisions need Tomáš Burda's (STK-025) sign-off. Gave a well-grounded business-value estimate (~250 handwritten service protocols/week, ~40h/~5MD monthly manual re-keying into ServiceNow, pulled from a note previously sent to Lukáš Síč) and shared a technical presentation confirming these figures and proposing a concrete automated-process architecture (dedicated intake email → PowerAutomate → AI extraction via API → reviewable Excel → ServiceNow import) — see `documents/client/2026-09-15-teo-ocr-technical-process-presentation.md`. Pushed back on Marek's proposed time/FTE-saved KPI in favor of a document-count/correction-rate framing; confirmed he received BigHub's API service spec the day before and is starting to test it. **On 2026-09-22**, has personally built out that proposed architecture concretely on Dr. Max's side: a live mailbox (`automat.revize@drmax.cz`), a defined folder structure (`914 Technicke/revize/automat/`), a twice-weekly Power Automate flow pushing documents to BigHub's Blob storage, and a daily local Power Automate Desktop + Python script watching for BigHub's processed output batches (tracked via local CSV), which builds a per-batch Excel for Míša's manual review and routes files through waiting → review → done → archive folders. Confirmed SPEDOS as a real 3rd pilot vendor (see [[ASM-127]]), will send back "correct" excel/json corrections to BigHub in a format to be agreed with Jura (operationalizing [[ASM-120]]), and asked BigHub directly what batch-creation logic it uses on the receiving side — not yet answered. Also the source of two flagged conflicts with very recent decisions needing reconciliation: Blob storage/deployment described as still depending on Dr. Max infra/BDC (see [[ASM-129]], contradicts ASM-088), and rejecting multi-candidate disambiguation output in favor of simple manual-review flags (see [[ASM-128]], appears to reverse ASM-119). Per Alana Sihelská (2026-09-25): young and capable, but no decision-making say on TEO direction. That sits with Tomáš Burda. Originated the TEO use case by cold-calling Alana. Treated as the entry point to Burda: Marek will gauge his openness to building beyond Excel in an informal call before any proposal ([[ASM-166]]). Source: 2026-09-07-ai-portfolio-roadmap-scope-review, 2026-09-15-business-quantification-teo-ocr, 2026-09-22-teo-ocr-technical-sync-spedos-disambiguation-reversal, 2026-09-25-alana-1on1-teo-phasing-capacity-pool-team-dynamics |
...
| Last interaction | 2026-09-24 (2026-09-24-viapharma-reklamace-knowledge-base-standoff) |
| Status | Active |
| Notes | Name spelling confirmed 2026-09-10 (was low-confidence "Egermajerová" from 2026-09-07) — attended directly, correctly transcribed as "EGRMAIEROVÁ Jana". Actively working with Tereza Foltýnová on consolidating the reklamace supplier Excel (3-4 source tables, not yet fully reconciled); has dedicated time allocated to this work. Floated by Tereza on 2026-09-15 as a possible Reklamace domain-expert alongside/instead of Petr Spilka (STK-014) — unconfirmed, Tereza to check with Spilka directly. Source: 2026-09-07-ai-portfolio-roadmap-scope-review, 2026-09-10-viapharma-reklamace-uat-fakturace-doprav-demo, 2026-09-15-business-quantification-reklamace-fakturace-doprav On 2026-09-25, Filip Černý credited her with a huge consolidation effort: she turned the ~300-sheet per-supplier Excel into a single ~300-row table. She is responsive (the only person who replied on the rozvozový list contract gap) and suggested ~2 editors per warehouse for supplier data. Jindřich will get the editor/viewer counts from her. Filip is ~90% sure she has edit access in Axapta. Source: 2026-09-25-reklamace-supplier-data-source-options. On 2026-09-24, hit an "invalid request" error testing "příjem s výhradou" with photos; proposed flagging each supplier as standard vs. specific procedure (~280 suppliers, ~75 with their own transport, ~35 needing specific handling; unvalidated). Her forwarded emails were mostly edge cases (~2 of ~10 straightforward). Tereza: "Jana knows a lot". Source: 2026-09-24-viapharma-reklamace-knowledge-base-standoff, 2026-09-25-tereza-foltynova-reklamace-focus-logistics-initiatives-table. |
...
| Last interaction | 2026-09-24 (2026-09-24-lexie-max-maxie-weekly-sync) |
| Status | Active |
| Notes | New contact, first appearance 2026-09-10. On 2026-09-17, in the Lexie/Max/Maxie weekly sync, offered to connect BigHub's test environment to Dr. Max's staging/test orders (unblocking phone-number-based order lookup testing for the Max chatbot); flagged a city/district-recognition bug (Brno-Líšeň not recognized as part of Brno) for Jura to investigate; raised a Lexie conversation-title bug (some titles save in English instead of Czech) to be filed as a ticket. Transcript shows her tagged twice in this meeting ("DrMax CZE" and "DrMax CZE1") — treated as the same person, likely a diarization artifact. On 2026-09-24, offered to provide order-status definitions and customer messaging for Max, including combinations with specific carriers, after Jura admitted he had assumed only delivering/delivered/cancelled. Source: 2026-09-10-lexie-max-maxie-weekly-sync, 2026-09-17-lexie-max-maxie-weekly-sync, 2026-09-24-lexie-max-maxie-weekly-sync |
...
| Last interaction | -tbd- (not yet contacted directly by Marek) |
| Status | Active |
| Notes | Named by Luboš Vosmek (STK-011) as one of two MaxBuddy contacts, alongside Lukáš Sýč (see STK-031, possible identity overlap flagged). Marek initially assumed Trajer would be the fallback contact for roadmap/feature questions; Vosmek corrected this — Trajer only supplies data (reading pharmacy POS/Farmy receipt data via Power BI), and is not involved in any functionality or roadmap decisions. **BQ tracker (2026-09-25)**: confirmed as supplying MaxBuddy's input data only (data warehouse / Power BI), not involved in functionality decisions. Source: 2026-09-17-business-quantification-maxbuddy-vosmek, BQ tracker (new_Přehled), 2026-09-25 |
...
|-------|-------|
| ID | STK-051 |
| Name | "pan Žák" (name uncertain) |
| Aliases | — |
| Organization | Dr. Max |
| Role | Generální ředitel (CEO) |
| Location | -tbd- |
| Influence | Presumed high (CEO) |
| Sentiment | -tbd- |
| Sentiment context | -tbd- |
| Communication preference | -tbd- |
| Expectations | -tbd- |
| Last interaction | -tbd- (not yet directly contacted by BigHub) |
| Status | Active |
| Notes | Low-confidence entry — single mention, surname uncertain from Alana's/Jindřich's notes. Named by Jindřich Tůma as the level he may escalate the AKS/BDC request-turnaround bottleneck to, at the 2026-09-29 management meeting, if pushing at Dudaško's level doesn't produce change. Kept per PM instruction to route everything; needs verification. Source: 2026-09-23-cross-project-status-sync-reklamace-fallout-listing-blockers |
...
| Last interaction | -tbd- (not yet directly contacted by BigHub) |
| Status | Active |
| Notes | First mention 2026-09-24: Tomáš Dudaško had already connected BigHub with him so marketing's AI initiatives can be captured into the Business Quantification tracker format as part of the end-of-November department backlog effort ([[ASM-161]]). Jindřich Tůma had also discussed a marketing connection with Honza Kabát. Source: 2026-09-24-ai-initiatives-bq-review-platform-prototype-demo-dudasko |
...
|-------|-------|
| ID | STK-053 |
| Name | Miroslav Tlustý |
| Aliases | — |
| Organization | Dr. Max |
| Role | Owner of ideas "Aplikace pro cenotvorbu" (automated pricing management) and "Produktový katalog" (standardized product-info entry) |
| Location | -tbd- |
| Influence | -tbd- |
| Sentiment | -tbd- |
| Sentiment context | -tbd- |
...
| Last interaction | -tbd- (not yet directly contacted by BigHub) |
| Status | Active |
| Notes | Named as an idea owner in the BQ tracker's ideas backlog; relevant to the end-of-November department backlog effort ([[ASM-161]]). Source: BQ tracker (new_Přehled), 2026-09-25 |
...
| Aliases | — |
| Organization | Dr. Max |
| Role | Owner of ideas "PBI analýza", "Přepis mluveného slova → email/zápis" and "Kontrola bannerů (šablona, legal, ikony)" |
| Location | -tbd- |
| Influence | -tbd- |
| Sentiment | -tbd- |
| Sentiment context | -tbd- |
...
| Aliases | — |
| Organization | Dr. Max |
| Role | Owner of ideas "Predikce PW" (300k Kč/yr), "Generická substituce" (150k Kč/yr) and "Automatické objednávání od distributorů" (70k Kč/yr); the only idea owner with quantified values |
| Location | -tbd- |
| Influence | -tbd- |
| Sentiment | -tbd- |
| Sentiment context | -tbd- |
...
| Aliases | — |
| Organization | Dr. Max |
| Role | Owner of idea "Automatizace helpdesku" |
| Location | -tbd- |
| Influence | -tbd- |
| Sentiment | -tbd- |
| Sentiment context | -tbd- |
